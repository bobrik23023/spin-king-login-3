...
function logDrop(mult){var chip=document.createElement("span");chip.className="drop-chip-688e8167"+
...
function say(text,mood){noteEl.textContent=text;noteEl.classList.remove("drop-note-up","drop-note-down");if(mood==="up"){noteEl.classList.add("drop-note-up-688e8167");}else if(mood==="down"){noteEl.classList.add("drop-note-down-688e8167");}}
